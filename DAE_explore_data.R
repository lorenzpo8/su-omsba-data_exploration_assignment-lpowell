...
#class(big_merge$NPT4_PRIV)
#select(scorecard, 'md_earn_wne_p10')
#select(big_merge, 'md_earn_wne_p10')
#range(big_merge, 'md_earn_wne_p10')
...
ggplot(big_merge_stand, aes(x = index_stand, y = md_earn_wne_p10))+
  geom_point()
