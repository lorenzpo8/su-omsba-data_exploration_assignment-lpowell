...
10 year median earnings can be identified by the three following groups:
  ...
  Med:    31101 - 44600
  High:   44601- 166200 
Though only average values in 3 tiers were calculated there is evidence of left skewed distirbution, a T-test would be usefull for small sub-sample regression to properly consider the impact of high earning outliers. 
...
Another notable model which controls for 'Institution Name' to hopefully avoid an unobserved effect of institution prestice. 'date/year_index_reg' differ in enrollment period level from month & week to annual intervals. These model's do not account for the aforementioned post-graduate financial outcomes but have comparable R2 values; however these models suggest a strong positive relationship between 'Enrollment Period' and 'Standardized Index Score'.
